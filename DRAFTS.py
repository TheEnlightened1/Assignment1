...
#def compute_trajectory():
    ...
    while velocity < v_lift:
        ...
        position = x0 + velocity*(t_i) + 0.5 * accel * (t_i**2) ##THIS NOW WORKS - WTF, WHAT ABOUT VELOCITY? Matches task sheet, starts to go a little off at
        x0 = position                                          ##15 values in (13.462) compared to task sheet. Out by 5 at the end but incrementing correct all the way

        velocity = velocity + (accel * t_i) #NOT
